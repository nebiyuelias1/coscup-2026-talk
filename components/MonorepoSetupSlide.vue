        ...
        <div v-if="activeTab === 'ios'" class="space-y-1.5 animate-fade-in">
          ...
          >
            <span class="text-blue-400 font-bold"
              >ios/ — Swift Xcode Project Structure</span
            >
            <span
        ...
        <div v-if="activeTab === 'android'" class="space-y-1.5 animate-fade-in">
          ...
          >
            <span class="text-emerald-400 font-bold"
              >android/ — Kotlin Gradle Project Structure</span
            >
            <span
    ...
    >
      <span class="text-slate-300">
        <template v-if="activeTab === 'backend'">
          💎 <strong>Rails Backend:</strong> Houses models, controllers & ERB
          views + serves dynamic navigation rules for mobile.
        </template>
        <template v-if="activeTab === 'ios'">
          🍏 <strong>iOS Project:</strong> Xcode project inside
          <code class="text-blue-300">/ios</code> folder with Swift
          <code class="text-blue-300">SceneDelegate</code> entry.
        </template>
        <template v-if="activeTab === 'android'">
          🤖 <strong>Android Project:</strong> Gradle project inside

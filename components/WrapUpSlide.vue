<template>
  <div class="flex flex-col items-center justify-center h-auto my-auto px-4 text-center relative z-10 py-2">
    ...
    <div class="flex items-center gap-2 mb-2">
      <span class="rails-badge">💎 Wrap Up</span>
    ...
    <div class="bg-slate-900/90 border border-red-500/40 rounded-2xl p-5 max-w-2xl w-full shadow-2xl backdrop-blur-md text-left">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
        ...
        <!-- Right: QR Code / Landing Page Link Box -->
        <div class="bg-slate-950 p-3 rounded-xl border border-slate-800 text-center flex flex-col items-center justify-center space-y-2">
          <!-- QR Code SVG for https://netale.et/#talks -->
    ...
    <!-- Post-Talk Hallway Track Invitation -->
    <div class="mt-4 p-2.5 bg-blue-950/50 border border-blue-500/40 rounded-xl max-w-2xl w-full text-xs text-blue-200 font-semibold flex items-center justify-center gap-2">
      <span>🤝 <strong>Hallway Track Invite:</strong> I'll be in the hallway outside for the next hour—let's chat about Rails, Hotwire, or open roles!</span>
    </div>
